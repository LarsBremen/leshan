...
public class Security extends BaseInstanceEnabler {
  ...
  private final static List<Integer> supportedResources = Arrays
      .asList(SEC_SERVER_URI, SEC_BOOTSTRAP,
  ...
  public Security(String serverUri, boolean bootstrapServer, int securityMode,
      byte[] publicKeyOrIdentity,
  ...
  public static Security noSecBootstap(String serverUri) {
    return new Security(serverUri, true, SecurityMode.NO_SEC.code, new byte[0], new byte[0],
        new byte[0], 0);
  }
   ...
   */
  public static Security rpkBootstrap(String serverUri, byte[] clientPublicKey,
      byte[] clientPrivateKey,
      byte[] serverPublicKey) {
    return new Security(serverUri, true, SecurityMode.RPK.code, clientPublicKey.clone(),
  ...
  public static Security noSec(String serverUri, int shortServerId) {
    return new Security(serverUri, false, SecurityMode.NO_SEC.code, new byte[0], new byte[0],
        new byte[0],
        shortServerId);
  }
   ...
   */
  public static Security psk(String serverUri, int shortServerId, byte[] pskIdentity,
      byte[] privateKey) {
   ...
   */
  public static Security rpk(String serverUri, int shortServerId, byte[] clientPublicKey,
      byte[] clientPrivateKey,
      byte[] serverPublicKey) {
    return new Security(serverUri, false, SecurityMode.RPK.code, clientPublicKey.clone(),
        serverPublicKey.clone(),
