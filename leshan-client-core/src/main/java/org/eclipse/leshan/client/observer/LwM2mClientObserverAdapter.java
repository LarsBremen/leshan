...
/**
 * An abstract adapter class for observing registration life cycle. The methods in this class are
 * empty. This class exists as convenience for creating client observer objects.
 */
