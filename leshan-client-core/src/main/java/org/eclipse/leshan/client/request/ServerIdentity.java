...
/**
 * Extend the identity with client relevant additional information. Introduce roles for the identity
 * and makes those roles accessible within the processing context of the Identity.
 *
...
public class ServerIdentity extends Identity {
  ...
  enum Role {
    /**
     * Indicate internal call. Enables the "system" to read protected resources (e.g. resources of
     * the security object).
     */
    SYSTEM,
    /**
