...
public class CoapAsyncRequestObserver extends AbstractRequestObserver {
  ...
  public void onTimeout() {
    ...
    errorCallback.onError(
        new org.eclipse.leshan.core.request.exception.TimeoutException("Request %s timed out",
            coapRequest.getURI()));
  }
  ...
  public void onCancel() {
    ...
    if (responseTimedOut.get()) {
      ...
      errorCallback
          .onError(new RequestCanceledException("Request %s cancelled", coapRequest.getURI()));
    }
  }
  ...
  public void onReject() {
    cancelCleaningTask();
    errorCallback
        .onError(new RequestRejectedException("Request %s rejected", coapRequest.getURI()));
  }
