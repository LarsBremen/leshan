...
public class ResponseCodeUtil {
  ...
  public static org.eclipse.californium.core.coap.CoAP.ResponseCode toCoapResponseCode(
    ...
    try {
      return org.eclipse.californium.core.coap.CoAP.ResponseCode
          .valueOf(toCoapCode(Lwm2mResponseCode.getCode()));
    } catch (MessageFormatException e) {
      throw new IllegalArgumentException(
          "Invalid CoAP code for LWM2M response: " + Lwm2mResponseCode);
    }
  }
}
