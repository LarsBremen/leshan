 ...
 * </p>
 * <p>
 * {@link EventSource.Emitter} is the active half of the connection and allows to operate on the
 * connection.
 * </p>
 * <p>
 * {@link EventSource} allows applications to be notified of events happening on the connection; two
 * events are being notified: the opening of the event source connection, where method {@link
 * EventSource#onOpen(Emitter)} is invoked, and the closing of the event source connection, where
 * method {@link EventSource#onClose()} is invoked.
 * </p>
 *
...
public interface EventSource {
  ...
  /**
   * <p>
   * {@link Emitter} is the active half of an event source connection, and allows applications to
   * operate on the connection by sending events, data or comments, or by closing the connection.
   * </p>
   * <p>
  ...
  public interface Emitter {
     ...
     * </pre>
     * <p>
     * When invoked as: <code>data("foo\r\nbar\rbaz\nbax")</code>, the client will receive the
     * lines:
     * </p>
     *
     * <pre>
