...
public class CoapMessage {
  ...
  public CoapMessage(Request request, boolean incoming) {
    this(incoming, request.getType(), request.getMID(), request.getTokenString(),
  ...
  private CoapMessage(boolean incoming, Type type, int mId, String token, OptionSet options,
      byte[] payload) {
