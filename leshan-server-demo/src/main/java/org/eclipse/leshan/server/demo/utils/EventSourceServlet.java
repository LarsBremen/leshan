...
/**
 * <p>
 * A servlet that implements the <a href="http://www.w3.org/TR/eventsource/">event source
 * protocol</a>, also known as "server sent events".
 * </p>
 * <p>
 * This servlet must be subclassed to implement abstract method {@link
 * #newEventSource(HttpServletRequest)} to return an instance of {@link EventSource} that allows
 * application to listen for event source events and to emit event source events.
 * </p>
 * <p>
...
public abstract class EventSourceServlet extends HttpServlet {
  ...
  protected class EventSourceEmitter implements EventSource.Emitter, Runnable {
    ...
    public EventSourceEmitter(EventSource eventSource, Continuation continuation)
        throws IOException {
