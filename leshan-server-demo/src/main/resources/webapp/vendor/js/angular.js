...
// with correct but slower alternatives.
  ...
  if (isNaN(msie)) {
    msie = int((/trident\/.*; rv:(\d+)/.exec(lowercase(navigator.userAgent))
        || [])[1]);
  }
  ...
  var trim = (function () {
    ...
    if (!String.prototype.trim) {
      return function (value) {
        return isString(value) ? value.replace(/^\s\s*/, '').replace(/\s\s*$/,
            '') : value;
      };
    }
    return function (value) {
  ...
  function csp() {
    return (document.securityPolicy && document.securityPolicy.isActive) ||
        (document.querySelector &&
            !!(document.querySelector('[ng-csp]') || document.querySelector(
                '[data-ng-csp]')));
  }
  ...
  function toBoolean(value) {
    if (typeof value === 'function') {
      ...
      value = !(v == 'f' || v == '0' || v == 'false' || v == 'no' || v == 'n'
          || v == '[]');
    } else {
      value = false;
    }
  ...
  function parseKeyValue(/**string*/keyValue) {
    ...
    forEach((keyValue || "").split('&'), function (keyValue) {
      if (keyValue) {
        ...
        if (isDefined(key)) {
          var val = isDefined(key_value[1]) ? tryDecodeURIComponent(
              key_value[1]) : true;
          if (!obj[key]) {
            obj[key] = val;
...
/////////////////////////////////////////////
  ...
  function jqLitePatchJQueryRemove(name, dispatchThis, filterElems,
      getterIfNoArguments) {
    ...
    function removePatch(param) {
      ...
      if (!getterIfNoArguments || param != null) {
        while (list.length) {
          set = list.shift();
          for (setIndex = 0, setLength = set.length; setIndex < setLength;
              setIndex++) {
...
/////////////////////////////////////////////
  ...
  function jqLiteAddNodes(root, elements) {
    if (elements) {
      elements = (!elements.nodeName && isDefined(elements.length) && !isWindow(
          elements))
          ? elements
          : [elements];
  ...
  function jqLiteEmpty(element) {
    for (var i = 0, childNodes = element.childNodes; i < childNodes.length;
        i++) {
...
//////////////////////////////////////////
  var JQLitePrototype = JQLite.prototype = {
    ...
    eq: function (index) {
      return (index >= 0) ? jqLite(this[index]) : jqLite(
...
//////////////////////////////////////////
  ...
  forEach({
    ...
    scope: function (element) {
      ...
      return jqLite(element).data('$scope') || jqLiteInheritedData(
          element.parentNode || element, ['$isolateScope', '$scope']);
    },

    isolateScope: function (element) {
      // Can't use jqLiteData here directly so we stay compatible with jQuery!
      return jqLite(element).data('$isolateScope') || jqLite(element).data(
    ...
    JQLite.prototype[name] = function (arg1, arg2) {
      ...
      if (fn !== jqLiteEmpty &&
          (((fn.length == 2 && (fn !== jqLiteHasClass && fn
        ...
        if (isObject(arg1)) {
          ...
          var jj = (value === undefined) ? Math.min(this.length, 1)
              : this.length;
          for (var j = 0; j < jj; j++) {
...
//////////////////////////////////////////
  forEach({
    ...
    on: function onFn(element, type, fn, unsupported) {
      ...
      if (!handle) {
        jqLiteExpandoStore(element, 'handle',
      ...
      forEach(type.split(' '), function (type) {
        ...
        if (!eventFns) {
          if (type == 'mouseenter' || type == 'mouseleave') {
            var contains = document.body.contains
            ...
            onFn(element, eventmap[type], function (event) {
              ...
              if (!related || (related !== target && !contains(target,
                  related))) {
                handle(event, type);
              }
            });
      ...
      forEach(modulesToLoad, function (module) {
        ...
        try {
          if (isString(module)) {
            ...
            for (invokeQueue = moduleFn._invokeQueue, i = 0, ii = invokeQueue.length;
                i < ii; i++) {
      ...
      function ($window, $location, $rootScope) {
        ...
        function getFirstAnchor(list) {
          ...
          forEach(list, function (element) {
            if (!result && lowercase(element.nodeName)
                === 'a') {
              result = element;
            }
          });
        ...
        function scroll() {
          ...
          else if ((elm = getFirstAnchor(
              document.getElementsByName(hash)))) {
            elm.scrollIntoView();
    ...
    self.cookies = function (name, value) {
      ...
      if (name) {
        if (value === undefined) {
          ...
          if (isString(value)) {
            cookieLength = (rawDocument.cookie = escape(name) + '=' + escape(
                value) +
 ...
 * ngTransclude}. The advantage of transclusion is that the linking function receives a
      ...
      function ($injector, $interpolate, $exceptionHandler, $http,
        ...
        var startSymbol = $interpolate.startSymbol(),
            ...
            denormalizeTemplate = (startSymbol == '{{' || endSymbol == '}}')
                ...
                : function denormalizeTemplate(template) {
                  return template.replace(/\{\{/g, startSymbol).replace(/}}/g,
                      endSymbol);
                },
        ...
        function compile($compileNodes, transcludeFn, maxPriority,
          ...
          forEach($compileNodes, function (node, index) {
            if (node.nodeType == 3 /* text node */ && node.nodeValue.match(
                /\S+/) /* non-empty */) {
              $compileNodes[index] = node = jqLite(node).wrap(
                  '<span></span>').parent()[0];
            }
          });
          var compositeLinkFn =
          ...
          return function publicLinkFn(scope, cloneConnectFn,
            ...
            for (var i = 0, ii = $linkNode.length; i < ii; i++) {
              ...
              if (nodeType === 1 /* element */ || nodeType
                  === 9 /* document */) {
        ...
        function createBoundTranscludeFn(scope, transcludeFn) {
          return function boundTranscludeFn(transcludedScope, cloneFn,
              controllers) {
          ...
          switch (nodeType) {
            case 1: /* Element */
              ...
              addDirective(directives,
                  directiveNormalize(nodeName_(node).toLowerCase()), 'E',
                  maxPriority, ignoreDirective);

              // iterate over the attributes
              for (var attr, name, nName, ngAttrName, value,
         ...
         */
        function applyDirectivesToNode(directives, compileNode, templateAttrs,
            transcludeFn,
          ...
          for (var i = 0, ii = directives.length; i < ii; i++) {
            ...
            if (directiveValue = directive.transclude) {
              ...
              if (directiveValue == 'element') {
                ...
                replaceWith(jqCollection, jqLite(sliceArgs($template)),
                    compileNode);
            ...
            if (directive.template) {
              ...
              if (directive.replace) {
                ...
                var templateDirectives = collectDirectives(compileNode, [],
                    newTemplateAttrs);
                var unprocessedDirectives = directives.splice(i + 1,
            ...
            if (directive.templateUrl) {
              ...
              nodeLinkFn = compileTemplateUrl(
                  ...
                  templateAttrs, jqCollection, childTranscludeFn, preLinkFns,
                  postLinkFns, {
                    controllerDirectives: controllerDirectives,
          ...
          function addLinkFns(pre, post, attrStart, attrEnd) {
            if (pre) {
              if (attrStart) {
                pre = groupElementsLinkFnWrapper(pre, attrStart,
                    attrEnd);
              }
            ...
            if (post) {
              if (attrStart) {
                post = groupElementsLinkFnWrapper(post, attrStart,
                    attrEnd);
              }
          ...
          function getControllers(directiveName, require, $element,
            ...
            if (isString(require)) {
              ...
              value = value || $element[retrievalMethod](
                  '$' + require + 'Controller');
          ...
          function nodeLinkFn(childLinkFn, scope, linkNode, $rootElement,
            ...
            var attrs, $element, i, ii, linkFn, controller, isolateScope,
                elementControllers = {}, transcludeFn;
            ...
            if (newIsolateScopeDirective) {
              ...
              if (templateDirective && (templateDirective
                    ...
                    switch (mode) {
                      ...
                      default:
                        throw $compileMinErr('iscp',
                            ...
                            +
                            " Definition: {... {1}: '{2}' ...}",
                            newIsolateScopeDirective.name, scopeName,
                            definition);
                    }
                  });
            }
            ...
            for (i = 0, ii = preLinkFns.length; i < ii; i++) {
              try {
                ...
                linkFn(linkFn.isolateScope ? isolateScope : scope, $element,
                    attrs,
                    linkFn.require && getControllers(linkFn.directiveName,
                    linkFn.require, $element, elementControllers),
                    transcludeFn);
              } catch (e) {
                ...
                if ((maxPriority === undefined || maxPriority
                  ...
                  if (startAttrName) {
                    directive = inherit(directive,
                        {$$start: startAttrName, $$end: endAttrName});
                  }
        ...
        function compileTemplateUrl(directives, $compileNode, tAttrs,
          ...
          $http.get($sce.getTrustedResourceUrl(templateUrl),
              {cache: $templateCache}).success(function (content) {
            ...
            afterTemplateNodeLinkFn = applyDirectivesToNode(directives,
                compileNode, tAttrs,
                childTranscludeFn, $compileNode, origAsyncDirective, preLinkFns,
                postLinkFns,
                previousCompileContext);
      ...
      return function (expression, locals) {
        ...
        if (isString(expression)) {
          ...
          expression = controllers.hasOwnProperty(constructor)
              ...
              : getter(locals.$scope, constructor, true) || getter($window,
              constructor, true);
    ...
    expect(data.getText()).toMatch('Request failed');
        ...
        function $http(requestConfig) {
          ...
          var xsrfValue = urlIsSameOrigin(config.url)
              ...
              : undefined;
          if (xsrfValue) {
            headers[(config.xsrfHeaderName
                || defaults.xsrfHeaderName)] = xsrfValue;
          }

          var serverRequest = function (config) {
            headers = config.headers;
            var reqData = transformData(config.data, headersGetter(headers),
              ...
              if (cachedResp.then) {
                ...
                if (isArray(cachedResp)) {
                  resolvePromise(cachedResp[1], cachedResp[0],
                      shallowCopy(cachedResp[2]), cachedResp[3]);
                } else {
  ...
  function createXhr(method) {
    ...
    throw minErr('$httpBackend')('noxhr',
 ...
 * $httpBackend} which can be trained with responses.
    ...
    this.$get = ['$browser', '$window', '$document',
      function ($browser, $window, $document) {
        return createHttpBackend($browser, createXhr, $browser.defer,
            $window.angular.callbacks, $document[0]);
      }];
  }
  ...
  function createHttpBackend($browser, createXhr, $browserDefer, callbacks,
    ...
    return function (method, url, post, callback, headers, timeout,
      ...
      function completeRequest(callback, status, response, headersString,
        ...
        if (status === 0) {
          status = response ? 200 : urlResolve(url).protocol == 'file' ? 404
              : 0;
        }
    ...
    function jsonpReq(url, callbackId, done) {
      ...
      if (msie <= 8) {
        script.onreadystatechange = function () {
          if (isString(script.readyState) && /loaded|complete/.test(
              script.readyState)) {
        ...
        function $interpolate(text, mustHaveExpression, trustedContext) {
          ...
          while (index < length) {
            if (((startIndex = text.indexOf(startSymbol, index)) != -1) &&
              ...
              (index != startIndex) && parts.push(
                  text.substring(index, startIndex));
              parts.push(fn = $parse(
                  exp = text.substring(startIndex + startSymbolLength,
                      endIndex)));
              fn.exp = exp;
  ...
  function LocationHashbangUrl(appBase, hashPrefix) {
     ...
     */
    this.$$parse = function (url) {
      var withoutBaseUrl = beginsWith(appBase, url) || beginsWith(appBaseNoFile,
          url);
      ...
      if (!isString(withoutHashUrl)) {
        throw $locationMinErr('ihshprfx',
            'Invalid url "{0}", missing hash prefix "{1}".', url,
            hashPrefix);
      }
    ...
    this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
      function ($rootScope, $browser, $sniffer, $rootElement) {
        ...
        $rootElement.on('click', function (event) {
          ...
          if (isObject(absHref) && absHref.toString()
    ...
    if (obj) {
      if (obj.constructor === obj) {
        ...
        throw $parseMinErr('isecwindow',
          ...
          obj.children && (obj.nodeName || (obj.prop && obj.attr
          && obj.find))) {
  ...
  Lexer.prototype = {
    ...
    lex: function (text) {
      ...
      while (this.index < this.text.length) {
        ...
        } else if (this.isNumber(this.ch) || this.is('.') && this.isNumber(
            this.peek())) {
          this.readNumber();
    ...
    peek: function (i) {
      var num = i || 1;
      return (this.index + num < this.text.length) ? this.text.charAt(
          this.index + num) : false;
    },
    ...
    throwError: function (error, start, end) {
      ...
      var colStr = (isDefined(start)
          ? 's ' + start + '-' + this.index + ' [' + this.text.substring(start,
          end) + ']'
          : ' ' + end);
      ...
      if ((token = this.expect('='))) {
        if (!left.assign) {
          this.throwError('implies assignment but [' +
              this.text.substring(0, token.index) + '] can not be assigned to',
              token);
        }
        right = this.ternary();
...
//////////////////////////////////////////////////
  ...
  function getterFn(path, options, fullExp) {
    ...
    if (!options.unwrapPromises && pathKeysLength === 1) {
      ...
      if (pathKeysLength < 6) {
        fn = cspSafeGetterFn(pathKeys[0], pathKeys[1], pathKeys[2], pathKeys[3],
            pathKeys[4], fullExp,
            options);
      } else {
        fn = function (scope, locals) {
          var i = 0, val;
          do {
            val = cspSafeGetterFn(pathKeys[i++], pathKeys[i++], pathKeys[i++],
                pathKeys[i++],
    ...
    this.$get = ['$filter', '$sniffer', '$log',
      function ($filter, $sniffer, $log) {
        ...
        promiseWarning = function promiseWarningFn(fullExp) {
          if (!$parseOptions.logPromiseWarnings
              || promiseWarningCache.hasOwnProperty(fullExp)) {
            return;
          }
          promiseWarningCache[fullExp] = true;
          $log.warn(
              '[$parse] Promise found in the expression `' + fullExp + '`. ' +
      ...
      deferred = {
        ...
        promise: {
          then: function (callback, errback, progressback) {
            ...
            if (pending) {
              pending.push(
                  [wrappedCallback, wrappedErrback, wrappedProgressback]);
            } else {
    ...
    this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
       ...
       *   $digest()} and should return the value that will be watched. (Since
                        ...
                        try {
                          ...
                          if (watch) {
                            if ((value = watch.get(current))
                                ...
                                !(watch.eq
                                    ? equals(value, last)
                                    : (typeof value == 'number' && typeof last
                                        == 'number'
          ...
          $destroy: function () {
            ...
            forEach(this.$$listenerCount,
                bind(null, decrementListenerCount, this));
          ...
          $broadcast: function (name, args) {
            ...
            while ((current = next)) {
              ...
              if (!(next = ((current.$$listenerCount[name]
                  && current.$$childHead) ||
                  (current !== target && current.$$nextSibling)))) {
...
// Prereq: s is a string.
  function escapeForRegexp(s) {
    return s.replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, '\\$1').replace(/\x08/g,
        '\\x08');
  }
  ...
  function $SnifferProvider() {
    this.$get = ['$window', '$document', function ($window, $document) {
      var eventSupport = {},
          android =
              int((/android (\d+)/.exec(
                  lowercase(($window.navigator || {}).userAgent)) || [])[1]),
      ...
      if (bodyStyle) {
        for (var prop in bodyStyle) {
          if (match = vendorRegex.exec(prop)) {
            ...
            vendorPrefix = vendorPrefix.substr(0, 1).toUpperCase()
      ...
      return {
        ...
        // jshint -W018
        history: !!($window.history && $window.history.pushState && !(android
            < 4) && !boxee),
        // jshint +W018
    ...
    return function (array, expression, comparator) {
      ...
      if (comparatorType !== 'function') {
        if (comparatorType === 'boolean' && comparator) {
          ...
          comparator = function (obj, text) {
            if (obj && text && typeof obj === 'object' && typeof text
                === 'object') {
          ...
          for (var key in expression) {
            (function (path) {
              ...
              predicates.push(function (value) {
                return search(path == '$' ? value : (value && value[path]),
                    expression[path]);
              });
            })(key);
          }
  ...
  function currencyFilter($locale) {
    ...
    return function (amount, currencySymbol) {
      ...
      return formatNumber(amount, formats.PATTERNS[1], formats.GROUP_SEP,
          formats.DECIMAL_SEP, 2).replace(/\u00A4/g, currencySymbol);
    };
  }
  ...
  function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
    ...
    if (!hasExponent) {
      ...
      if (fractionSize && fractionSize !== "0") {
        formatedText += decimalSep
            + fraction.substr(0, fractionSize);
      }
    } else {
    ...
    compile: function (element, attr) {
      ...
      if (!attr.href && !attr.xlinkHref && !attr.name) {
        return function (scope, element) {
          ...
          var href = toString.call(element.prop('href'))
          === '[object SVGAnimatedString]' ?
              'xlink:href' : 'href';
    ...
    ngAttributeAliasDirectives[normalized] = function () {
      return {
        ...
        link: function (scope, element, attr) {
          ...
          if (attrName === 'href' &&
              toString.call(element.prop('href'))
              === '[object SVGAnimatedString]') {
            name = 'xlinkHref';
...
// a pattern that is repeated a lot in the input validation logic.
  ...
  function addNativeHtml5Validators(ctrl, validatorName, element) {
    ...
    if (isObject(validity)) {
      var validator = function (value) {
        ...
        if (!ctrl.$error[validatorName] && (validity.badInput
  ...
  function textInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    var listener = function (ev) {
      ...
      if (msie && (ev || noevent).type === 'input' && element[0].placeholder
          !== placeholder) {
    ...
    if (pattern) {
      var validateRegex = function (regexp, value) {
        return validate(ctrl, 'pattern',
            ctrl.$isEmpty(value) || regexp.test(value), value);
      };
    ...
    if (attr.ngMinlength) {
      ...
      var minLengthValidator = function (value) {
        return validate(ctrl, 'minlength',
            ctrl.$isEmpty(value) || value.length >= minlength, value);
      };
    ...
    if (attr.ngMaxlength) {
      ...
      var maxLengthValidator = function (value) {
        return validate(ctrl, 'maxlength',
            ctrl.$isEmpty(value) || value.length <= maxlength, value);
      };
  ...
  function numberInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    if (attr.min) {
      var minValidator = function (value) {
        ...
        return validate(ctrl, 'min', ctrl.$isEmpty(value) || value >= min,
            value);
      };
    ...
    if (attr.max) {
      var maxValidator = function (value) {
        ...
        return validate(ctrl, 'max', ctrl.$isEmpty(value) || value <= max,
            value);
      };
    ...
    ctrl.$formatters.push(function (value) {
      return validate(ctrl, 'number', ctrl.$isEmpty(value) || isNumber(value),
          value);
    });
  }
  ...
  function urlInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    var urlValidator = function (value) {
      return validate(ctrl, 'url',
          ctrl.$isEmpty(value) || URL_REGEXP.test(value), value);
    };
  ...
  function emailInputType(scope, element, attr, ctrl, $sniffer, $browser) {
    ...
    var emailValidator = function (value) {
      return validate(ctrl, 'email',
          ctrl.$isEmpty(value) || EMAIL_REGEXP.test(value), value);
    };
  ...
  var inputDirective = ['$browser', '$sniffer', function ($browser, $sniffer) {
    return {
      ...
      link: function (scope, element, attr, ctrl) {
        if (ctrl) {
          (inputType[lowercase(attr.type)] || inputType.text)(scope, element,
              attr, ctrl, $sniffer,
              $browser);
        }
      }
  ...
  var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element',
    ...
    function ($scope, $exceptionHandler, $attr, $element, $parse, $animate) {
      ...
      if (!ngModelSet) {
        throw minErr('ngModel')('nonassign',
          ...
          return function (scope, $element, $attr, ctrl, $transclude) {
            ...
            scope.$watch($sce.parseAsResourceUrl(srcExp),
                function ngIncludeWatchAction(src) {
                  ...
                  if (src) {
                    $http.get(src, {cache: $templateCache}).success(
                        function (response) {
      ...
      return {
        ...
        link: function (scope, element, attr) {
          ...
          forEach(whens, function (expression, key) {
            whensExpFns[key] =
                $interpolate(
                    expression.replace(BRACE, startSymbol + numberExp + '-' +
                        offset + endSymbol));
          });
    ...
    return {
      ...
      link: function ($scope, $element, $attr, ctrl, $transclude) {
        ...
        var match = expression.match(
            ...
            trackByExp, trackByExpGetter, trackByIdExpFn, trackByIdArrayFn,
            trackByIdObjFn,
        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
          ...
          for (index = 0, length = collectionKeys.length; index < length;
              index++) {
            key = (collection === collectionKeys) ? index
                : collectionKeys[index];
            value = collection[key];
            ...
            if (block.scope) {
              ...
              if (getBlockStart(block) != nextNode) {
                ...
                $animate.move(getBlockElements(block.clone), null,
                    jqLite(previousNode));
              }
  ...
  var ngHideDirective = ['$animate', function ($animate) {
    return function (scope, element, attr) {
      scope.$watch(attr.ngHide, function ngHideWatchAction(value) {
        $animate[toBoolean(value) ? 'addClass' : 'removeClass'](element,
            'ng-hide');
      });
    };
  }];
    ...
    return {
      ...
      link: function (scope, element, attr, ngSwitchController) {
        ...
        scope.$watch(watchExpr, function ngSwitchWatchAction(value) {
          ...
          if ((selectedTranscludes = ngSwitchController.cases['!' + value]
  ...
  var ngSwitchWhenDirective = ngDirective({
    ...
    link: function (scope, element, attrs, ctrl, $transclude) {
      ...
      ctrl.cases['!' + attrs.ngSwitchWhen].push(
          {transclude: $transclude, element: element});
    }
  });
...
// jshint maxlen: 100
    ...
    return {
      ...
      link: function (scope, element, attr, ctrls) {
        ...
        // find "null" option
        for (var i = 0, children = element.children(), ii = children.length;
            i < ii; i++) {
          if (children[i].value === '') {
            ...
            scope.$apply(function () {
              ...
              if (multiple) {
                ...
                for (groupIndex = 0, groupLength = optionGroupsCache.length;
                  ...
                  for (index = 1, length = optionGroup.length; index < length;
                      index++) {
                    if ((optionElement = optionGroup[index].element)[0].selected) {
                      ...
                      if (trackFn) {
                        for (trackIndex = 0; trackIndex < collection.length;
                            trackIndex++) {
          ...
          function render() {
            ...
            if (multiple) {
              if (trackFn && isArray(modelValue)) {
                ...
                for (var trackIndex = 0; trackIndex < modelValue.length;
                    trackIndex++) {
                  locals[valueName] = modelValue[trackIndex];
                  selectedSet.put(trackFn(scope, locals),
            ...
            for (index = 0; length = keys.length, index < length; index++) {
              ...
              if (multiple) {
                selected = isDefined(
                    selectedSet.remove(
                        trackFn ? trackFn(scope, locals) : valueFn(scope,
                            locals))
                );
              } else {
                if (trackFn) {
                  ...
                  selected = trackFn(scope, modelCast) === trackFn(scope,
                      locals);
                } else {
              ...
              optionGroup.push({
                ...
                id: trackFn ? trackFn(scope, locals) : (keyName ? keys[index]
                    : index),
                label: label,
            ...
            for (groupIndex = 0, groupLength = optionGroupNames.length;
              ...
              for (index = 0, length = optionGroup.length; index < length;
                  index++) {
...
!window.angular.$$csp() && window.angular.element(document).find(
    'head').prepend(
