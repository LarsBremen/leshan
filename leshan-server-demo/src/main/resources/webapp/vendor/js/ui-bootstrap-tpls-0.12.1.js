...
angular.module("ui.bootstrap",
    ["ui.bootstrap.tpls", "ui.bootstrap.transition", "ui.bootstrap.collapse",
      "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.bindHtml",
      "ui.bootstrap.buttons", "ui.bootstrap.carousel",
      "ui.bootstrap.dateparser", "ui.bootstrap.position",
      "ui.bootstrap.datepicker", "ui.bootstrap.dropdown", "ui.bootstrap.modal",
      "ui.bootstrap.pagination", "ui.bootstrap.tooltip", "ui.bootstrap.popover",
...
angular.module("ui.bootstrap.tpls", ["template/accordion/accordion-group.html",
  ...
  "template/datepicker/datepicker.html", "template/datepicker/day.html",
  "template/datepicker/month.html", "template/datepicker/popup.html",
  "template/datepicker/year.html", "template/modal/backdrop.html",
  "template/modal/window.html", "template/pagination/pager.html",
  "template/pagination/pagination.html",
  "template/tooltip/tooltip-html-unsafe-popup.html",
  "template/tooltip/tooltip-popup.html", "template/popover/popover.html",
  "template/progressbar/bar.html", "template/progressbar/progress.html",
  "template/progressbar/progressbar.html", "template/rating/rating.html",
...
.directive('bindHtmlUnsafe', function () {
  return function (scope, element, attr) {
    ...
    scope.$watch(attr.bindHtmlUnsafe,
      ...
      function ($scope, $timeout, $interval, $transition) {
        ...
        self.select = $scope.select = function (nextSlide, direction) {
          ...
          function goNext() {
            ...
            if (self.currentSlide && angular.isString(direction)
              ...
              angular.extend(nextSlide,
                  {direction: direction, active: true, entering: true});
              angular.extend(self.currentSlide || {},
                  {direction: direction, leaving: true});
          ...
          function transitionDone(next, current) {
            angular.extend(next,
                {direction: '', active: true, leaving: false, entering: false});
        ...
        $scope.prev = function () {
          var newIndex = currentIndex - 1 < 0 ? slides.length - 1 : currentIndex
              - 1;
...
.service('dateParser',
    ['$locale', 'orderByFilter', function ($locale, orderByFilter) {
      ...
      function isValid(year, month, date) {
        if (month === 1 && date > 28) {
          return date === 29 && ((year % 4 === 0 && year % 100 !== 0) || year
              % 400 === 0);
        }
...
.factory('$position', ['$document', '$window', function ($document, $window) {
  ...
  var parentOffsetEl = function (element) {
    ...
    while (offsetParent && offsetParent !== docDomEl && isStaticPositioned(
        offsetParent)) {
...
.controller('DatepickerController',
    ['$scope', '$attrs', '$parse', '$interpolate', '$timeout', '$log',
      'dateFilter', 'datepickerConfig',
      function ($scope, $attrs, $parse, $interpolate, $timeout, $log,
          dateFilter, datepickerConfig) {
        var self = this,
        ...
        angular.forEach(
            ['formatDay', 'formatMonth', 'formatYear', 'formatDayHeader',
              'formatDayTitle', 'formatMonthTitle',
              'minMode', 'maxMode', 'showWeeks', 'startingDay', 'yearRange'],
            function (key, index) {
              self[key] = angular.isDefined($attrs[key]) ? (index < 8
        ...
        angular.forEach(['minDate', 'maxDate'], function (key) {
          if ($attrs[key]) {
            ...
            self[key] = datepickerConfig[key] ? new Date(datepickerConfig[key])
                : null;
          }
        });
        ...
        this.activeDate = angular.isDefined($attrs.initDate)
            ? $scope.$parent.$eval($attrs.initDate) : new Date();
        ...
        this.refreshView = function () {
          if (this.element) {
            ...
            ngModelCtrl.$setValidity('date-disabled',
                !date || (this.element && !this.isDisabled(date)));
          }
        };

        this.createDateObject = function (date, format) {
          var model = ngModelCtrl.$modelValue ? new Date(
              ngModelCtrl.$modelValue) : null;
          return {
            date: date,
        ...
        $scope.select = function (date) {
          if ($scope.datepickerMode === self.minMode) {
            var dt = ngModelCtrl.$modelValue ? new Date(ngModelCtrl.$modelValue)
            ...
            $scope.datepickerMode = self.modes[self.modes.indexOf(
                $scope.datepickerMode) - 1];
          }
        };
        ...
        $scope.toggleMode = function (direction) {
          ...
          $scope.datepickerMode = self.modes[self.modes.indexOf(
              $scope.datepickerMode) + direction];
        };
    ...
    link: function (scope, element, attrs, ctrl) {
      ...
      ctrl.handleKeyDown = function (key, evt) {
        ...
        if (key === 'left') {
          ...
          date = Math.min(getDaysInMonth(ctrl.activeDate.getFullYear(),
...
.directive('monthpicker', ['dateFilter', function (dateFilter) {
  return {
    ...
    link: function (scope, element, attrs, ctrl) {
      ...
      ctrl.compare = function (date1, date2) {
        return new Date(date1.getFullYear(), date1.getMonth()) - new Date(
      ...
      ctrl.handleKeyDown = function (key, evt) {
        ...
        if (key === 'left') {
          ...
          var year = ctrl.activeDate.getFullYear() + (key === 'pageup' ? -1
              : 1);
  ...
  return {
    ...
    link: function (scope, element, attrs, ctrl) {
      ...
      ctrl._refreshView = function () {
        ...
        for (var i = 0, start = getStartingYear(ctrl.activeDate.getFullYear());
            i < range; i++) {
...
.directive('datepickerPopup',
    ['$compile', '$parse', '$document', '$position', 'dateFilter', 'dateParser',
      ...
      function ($compile, $parse, $document, $position, dateFilter, dateParser,
        ...
        return {
          ...
          link: function (scope, element, attrs, ngModel) {
            var dateFormat,
                closeOnDateSelection = angular.isDefined(
                    attrs.closeOnDateSelection) ? scope.$parent.$eval(
                    attrs.closeOnDateSelection)
            ...
            if (attrs.datepickerOptions) {
              angular.forEach(scope.$parent.$eval(attrs.datepickerOptions),
            ...
            scope.watchData = {};
            angular.forEach(['minDate', 'maxDate', 'datepickerMode'],
                function (key) {
                  if (attrs[key]) {
            ...
            if (attrs.dateDisabled) {
              datepickerEl.attr('date-disabled',
            ...
            function parseDate(viewValue) {
              if (!viewValue) {
                ...
                var date = dateParser.parse(viewValue, dateFormat) || new Date(
                    viewValue);
                if (isNaN(date)) {
            ...
            scope.$watch('isOpen', function (value) {
              if (value) {
                ...
                scope.position.top = scope.position.top + element.prop(
                    'offsetHeight');
...
.controller('DropdownController',
    ['$scope', '$attrs', '$parse', 'dropdownConfig', 'dropdownService',
      '$animate',
      function ($scope, $attrs, $parse, dropdownConfig, dropdownService,
          $animate) {
        var self = this,
        ...
        scope.$watch('isOpen', function (isOpen, wasOpen) {
          $animate[isOpen ? 'addClass' : 'removeClass'](self.$element,
              openClass);
        ...
        link: function (scope, element, attrs) {
          ...
          scope.close = function (evt) {
            ...
            if (modal && modal.value.backdrop && modal.value.backdrop
                != 'static' && (evt.target === evt.currentTarget)) {
              evt.preventDefault();
              evt.stopPropagation();
...
.factory('$modalStack',
    ['$transition', '$timeout', '$document', '$compile', '$rootScope',
      '$$stackedMap',
...
.provider('$modal', function () {
  ...
  var $modalProvider = {
    ...
    $get: ['$injector', '$rootScope', '$q', '$http', '$templateCache',
      ...
      function ($injector, $rootScope, $q, $http, $templateCache, $controller,
        ...
        function getTemplatePromise(options) {
          return options.template ? $q.when(options.template) :
              $http.get(angular.isFunction(options.templateUrl)
        ...
        $modal.open = function (modalOptions) {
          ...
          var templateAndResolvePromise =
              $q.all([getTemplatePromise(modalOptions)].concat(
...
.controller('PaginationController',
    ['$scope', '$attrs', '$parse', function ($scope, $attrs, $parse) {
      var self = this,
          ngModelCtrl = {$setViewValue: angular.noop}, // nullModelCtrl
          setNumPages = $attrs.numPages ? $parse($attrs.numPages).assign
              : angular.noop;
      ...
      this.calculateTotalPages = function () {
        var totalPages = this.itemsPerPage < 1 ? 1 : Math.ceil(
            $scope.totalItems / this.itemsPerPage);
      ...
      return {
        ...
        link: function (scope, element, attrs, ctrls) {
          ...
          var maxSize = angular.isDefined(attrs.maxSize) ? scope.$parent.$eval(
              attrs.maxSize) : paginationConfig.maxSize,
              rotate = angular.isDefined(attrs.rotate) ? scope.$parent.$eval(
                  attrs.rotate) : paginationConfig.rotate;
          ...
          function getPages(currentPage, totalPages) {
            ...
            var isMaxSized = (angular.isDefined(maxSize) && maxSize
                < totalPages);
            ...
            if (isMaxSized) {
              if (rotate) {
                ...
                startPage = ((Math.ceil(currentPage / maxSize) - 1) * maxSize)
                    + 1;
...
.provider('$tooltip', function () {
   ...
   */
  this.$get = ['$window', '$compile', '$timeout', '$document', '$position',
    '$interpolate',
          ...
          compile: function (tElem, tAttrs) {
            ...
            return function link(scope, element, attrs) {
              ...
              function prepPlacement() {
                ...
                ttScope.placement = angular.isDefined(val) ? val
                    : options.placement;
              }
...
.controller('ProgressController', ['$scope', '$attrs', 'progressConfig',
  function ($scope, $attrs, progressConfig) {
    ...
    this.bars = [];
    $scope.max = angular.isDefined($attrs.max) ? $scope.$parent.$eval(
        $attrs.max) : progressConfig.max;
    ...
    this.buildTemplateObjects = function (states) {
      for (var i = 0, n = states.length; i < n; i++) {
        states[i] = angular.extend({index: i},
            {stateOn: this.stateOn, stateOff: this.stateOff}, states[i]);
      }
      return states;
    };
    ...
    ['$scope', '$attrs', '$parse', '$log', '$locale', 'timepickerConfig',
      function ($scope, $attrs, $parse, $log, $locale, timepickerConfig) {
        ...
        function getHoursFromTemplate() {
          ...
          var valid = ($scope.showMeridian) ? (hours > 0 && hours < 13) : (hours
              >= 0 && hours < 24);
          if (!valid) {
            return undefined;
          }
        ...
        function pad(value) {
          return (angular.isDefined(value) && value.toString().length < 2) ? '0'
              + value : value;
        }
...
.directive('typeahead',
    ['$compile', '$parse', '$q', '$timeout', '$document', '$position',
      'typeaheadParser',
      function ($compile, $parse, $q, $timeout, $document, $position,
        ...
        return {
          ...
          link: function (originalScope, element, attrs, modelCtrl) {
            ...
            var isEditable = originalScope.$eval(attrs.typeaheadEditable)
                !== false;
            ...
            var appendToBody = attrs.typeaheadAppendToBody
                ? originalScope.$eval(attrs.typeaheadAppendToBody) : false;
            ...
            var getMatchesAsync = function (inputValue) {
              ...
              $q.when(parserResult.source(originalScope, locals)).then(
                  function (matches) {
                    ...
                    var onCurrentRequest = (inputValue
                        === modelCtrl.$viewValue);
                    if (onCurrentRequest && hasFocus) {
                      if (matches.length > 0) {
                        ...
                        scope.position = appendToBody ? $position.offset(
                            element) : $position.position(element);
                        scope.position.top = scope.position.top + element.prop(
                            'offsetHeight');
            ...
            element.bind('keydown', function (evt) {
              ...
              if (scope.activeIdx == -1 && (evt.which === 13 || evt.which
                  === 9)) {
                return;
              }
    ...
    return {
      ...
      link: function (scope, element, attrs) {
        var tplUrl = $parse(attrs.templateUrl)(scope.$parent)
            || 'template/typeahead/typeahead-match.html';
        $http.get(tplUrl, {cache: $templateCache}).success(
            function (tplContent) {
...
.filter('typeaheadHighlight', function () {
  ...
  return function (matchItem, query) {
    return query ? ('' + matchItem).replace(
