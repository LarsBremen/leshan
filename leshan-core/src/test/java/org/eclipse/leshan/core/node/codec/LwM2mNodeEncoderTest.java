...
public class LwM2mNodeEncoderTest {
  ...
  public void text_encode_single_resource() {
    ...
    byte[] encoded = encoder
        .encode(LwM2mSingleResource.newFloatResource(15, 56.4D), ContentFormat.TEXT,
  ...
  public void text_encode_date_as_long() {
    ...
    byte[] encoded = encoder
        .encode(LwM2mSingleResource.newStringResource(13, "2010-01-01T12:00:00+01:00"),
  ...
  public void text_encode_date_as_iso_string() {
    ...
    byte[] encoded = encoder
        .encode(LwM2mSingleResource.newIntegerResource(13, 1367491215000L), ContentFormat.TEXT,
  ...
  public void tlv_encode_device_object_instance_as_resources_array__undefined_instance_id() {
    LwM2mObjectInstance oInstance = new LwM2mObjectInstance(LwM2mObjectInstance.UNDEFINED,
        getDeviceResources());
  ...
  public void json_encode_timestamped_resources() throws CodecException {
    ...
    byte[] encoded = encoder
        .encodeTimestampedData(data, ContentFormat.JSON, new LwM2mPath(1024, 0, 1), model);
  ...
  public void json_encode_timestamped_instances() throws CodecException {
    ...
    LwM2mObjectInstance instanceAt110 = new LwM2mObjectInstance(0,
        LwM2mSingleResource.newFloatResource(1, 22.9));
    LwM2mObjectInstance instanceAt120 = new LwM2mObjectInstance(0,
        LwM2mSingleResource.newFloatResource(1, 22.4),
        LwM2mSingleResource.newStringResource(0, "a string"));
    LwM2mObjectInstance instanceAt130 = new LwM2mObjectInstance(0,
    ...
    byte[] encoded = encoder
        .encodeTimestampedData(data, ContentFormat.JSON, new LwM2mPath(1024, 0), model);
  ...
  public void json_encode_timestamped_Object() throws CodecException {
    ...
    byte[] encoded = encoder
        .encodeTimestampedData(data, ContentFormat.JSON, new LwM2mPath(1024), model);
