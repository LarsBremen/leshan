...
public class LwM2mNodeDecoderTest {
  ...
  public static void loadModel() {
    ...
    resForObj65.add(
        new ResourceModel(0, "res0", Operations.R, true, false, Type.OBJLNK, null, null, null));
    resForObj65.add(
        new ResourceModel(1, "res1", Operations.R, false, false, Type.STRING, null, null, null));
    resForObj65.add(
        new ResourceModel(2, "res2", Operations.R, false, false, Type.INTEGER, null, null, null));
    objects.add(
        new ObjectModel(65, "object link tests 65", "", ObjectModel.DEFAULT_VERSION, true, false,
            resForObj65));

    // add object 66 from the LWM2M v1.0.1 specification (figure 28)
    List<ResourceModel> resForObj66 = new ArrayList<>();
    resForObj66.add(
        new ResourceModel(0, "res0", Operations.R, true, false, Type.STRING, null, null, null));
    resForObj66.add(
        new ResourceModel(1, "res1", Operations.R, false, false, Type.STRING, null, null, null));
    resForObj66.add(
        new ResourceModel(2, "res2", Operations.R, false, false, Type.OBJLNK, null, null, null));
    objects.add(
        new ObjectModel(66, "object link tests 66", "", ObjectModel.DEFAULT_VERSION, true, false,
            resForObj66));
  ...
  private final static byte[] ENCODED_ACL = Hex
      .decodeHex("08000EC10001C101008302417F07C1037F080212C10003C101008702417F0761013601C1037F"
          .toCharArray());

  // tlv content for multi instance SERVER (encoded as an array of 1 Object instance TLV)
  // Example from LWM2M spec §4.3.2 C)
  private final static byte[] ENCODED_SERVER = Hex
      .decodeHex("08000FC10001C40100015180C10601C10755".toCharArray());
  ...
  private final static byte[] ENCODED_OBJ65 = Hex
      .decodeHex("88000C440000420000440100420001C8010D38363133383030373535353030C40212345678"
          .toCharArray());
  ...
  public void text_manufacturer_resource() throws CodecException {
    ...
    LwM2mSingleResource resource = (LwM2mSingleResource) decoder
  ...
  public void text_battery_resource() throws CodecException {
    LwM2mSingleResource resource = (LwM2mSingleResource) decoder
        .decode("100".getBytes(StandardCharsets.UTF_8),
  ...
  public void tlv_manufacturer_resource() throws CodecException {
    ...
    byte[] content = TlvEncoder
        .encode(new Tlv[]{new Tlv(TlvType.RESOURCE_VALUE, null, value.getBytes(), 0)})
        .array();
  ...
  public void tlv_device_object_instance0_from_resources_tlv() throws CodecException {
    ...
    LwM2mObjectInstance oInstance = (LwM2mObjectInstance) decoder
        .decode(ENCODED_DEVICE_WITHOUT_INSTANCE,
            ContentFormat.TLV, new LwM2mPath(3, 0), model);
    assertDeviceInstance(oInstance);
  }

  @Test
  public void tlv_device_object_instance0_from_resources_tlv__instance_expected()
      throws CodecException {

    LwM2mObjectInstance oInstance = decoder
        .decode(ENCODED_DEVICE_WITHOUT_INSTANCE, ContentFormat.TLV,
  ...
  public void tlv_device_object_instance0_from_instance_tlv() throws CodecException {
    ...
    LwM2mObjectInstance oInstance = (LwM2mObjectInstance) decoder
        .decode(ENCODED_DEVICE_WITH_INSTANCE,
            ContentFormat.TLV, new LwM2mPath(3, 0), model);
    assertDeviceInstance(oInstance);
  }
  ...
  public void tlv_server_object_multi_instance_with_only_1_instance() throws Exception {
    LwM2mObject oObject = ((LwM2mObject) decoder
        .decode(ENCODED_SERVER, ContentFormat.TLV, new LwM2mPath(1),
            model));
  ...
  public void tlv_acl_object_multi_instance() throws Exception {
    LwM2mObject oObject = ((LwM2mObject) decoder
        .decode(ENCODED_ACL, ContentFormat.TLV, new LwM2mPath(2), model));
  ...
  public void tlv_single_instance_with_obj_link() throws Exception {
    LwM2mObjectInstance oInstance = ((LwM2mObjectInstance) decoder
        .decode(ENCODED_OBJ65, ContentFormat.TLV,
  ...
  public void tlv_multi_instance_with_obj_link() throws Exception {
    LwM2mObject oObject = ((LwM2mObject) decoder
        .decode(ENCODED_OBJ66, ContentFormat.TLV, new LwM2mPath(66),
            model));
  ...
  public void tlv_power_source__array_values() throws CodecException {
    ...
    LwM2mResource resource = (LwM2mResource) decoder
        .decode(content, ContentFormat.TLV, new LwM2mPath(3, 0, 6),
            model);
  ...
  public void tlv_unknown_object__missing_instance_tlv() throws CodecException {
    ...
    byte[] content = TlvEncoder
        .encode(new Tlv[]{new Tlv(TlvType.RESOURCE_VALUE, null, "value1".getBytes(), 1),
            new Tlv(TlvType.RESOURCE_VALUE, null, "value1".getBytes(), 2)})
        .array();

    LwM2mObject obj = (LwM2mObject) decoder
  ...
  public void tlv_empty_object() {
    ...
    LwM2mObject obj = (LwM2mObject) decoder
        .decode(content, ContentFormat.TLV, new LwM2mPath(2), model);
  ...
  public void tlv_invalid_multi_resource_2_instance_with_the_same_id() {
    Tlv resInstance1 = new Tlv(TlvType.RESOURCE_INSTANCE, null,
        TlvEncoder.encodeObjlnk(new ObjectLink(100, 1)), 0);
    Tlv resInstance2 = new Tlv(TlvType.RESOURCE_INSTANCE, null,
        TlvEncoder.encodeObjlnk(new ObjectLink(101, 2)), 0);
    Tlv multiResource = new Tlv(TlvType.MULTIPLE_RESOURCE, new Tlv[]{resInstance1, resInstance2},
        null, 22);
  ...
  public void json_timestamped_resources() throws CodecException {
    ...
    List<TimestampedLwM2mNode> timestampedResources = decoder
        .decodeTimestampedData(b.toString().getBytes(),
  ...
  public void json_timestamped_instances() throws CodecException {
    ...
    assertEquals(22.4d,
        ((LwM2mObjectInstance) timestampedResources.get(0).getNode()).getResource(1).getValue());

    assertEquals(Long.valueOf(25462634L - 30), timestampedResources.get(1).getTimestamp());
    assertEquals(22.9d,
        ((LwM2mObjectInstance) timestampedResources.get(1).getNode()).getResource(1).getValue());

    assertEquals(Long.valueOf(25462634 - 50), timestampedResources.get(2).getTimestamp());
    assertEquals(24.1d,
        ((LwM2mObjectInstance) timestampedResources.get(2).getNode()).getResource(1).getValue());
  }
  ...
  public void json_timestamped_Object() throws CodecException {
    ...
    assertEquals(Long.valueOf(25462634L - 5), timestampedResources.get(0).getTimestamp());
    assertEquals(22.4d,
        ((LwM2mObject) timestampedResources.get(0).getNode()).getInstance(0).getResource(1)
            .getValue());
    assertEquals("a string",
        ((LwM2mObject) timestampedResources.get(0).getNode()).getInstance(0).getResource(0)
            .getValue());
    assertEquals(23.0d,
        ((LwM2mObject) timestampedResources.get(0).getNode()).getInstance(1).getResource(1)
            .getValue());
    assertEquals(Long.valueOf(25462634L - 30), timestampedResources.get(1).getTimestamp());
    assertEquals(22.9d,
        ((LwM2mObject) timestampedResources.get(1).getNode()).getInstance(0).getResource(1)
            .getValue());
    assertEquals(Long.valueOf(25462634 - 50), timestampedResources.get(2).getTimestamp());
    assertEquals(24.1d,
        ((LwM2mObject) timestampedResources.get(2).getNode()).getInstance(0).getResource(1)
            .getValue());
  }
  ...
  public void json_empty_object() {
    ...
    b.append("{}");
    LwM2mObject obj = (LwM2mObject) decoder
        .decode(b.toString().getBytes(), ContentFormat.JSON, new LwM2mPath(2),
            model);
    assertNotNull(obj);
    assertEquals(2, obj.getId());
    assertTrue(obj.getInstances().isEmpty());
    ...
    b = new StringBuilder();
    b.append("{\"e\":[]}");
    obj = (LwM2mObject) decoder
        .decode(b.toString().getBytes(), ContentFormat.JSON, new LwM2mPath(2), model);
    assertNotNull(obj);
    assertEquals(2, obj.getId());
    assertTrue(obj.getInstances().isEmpty());
  ...
  public void json_empty_instance() {
    ...
    StringBuilder b = new StringBuilder();
    b.append("{}");
    LwM2mObjectInstance instance = (LwM2mObjectInstance) decoder
        .decode(b.toString().getBytes(), ContentFormat.JSON,
            new LwM2mPath(2, 0), model);
    assertNotNull(instance);
    assertEquals(0, instance.getId());
    assertTrue(instance.getResources().isEmpty());
  ...
  public void json_empty_multi_resource() {
    ...
    b = new StringBuilder();
    b.append("{\"e\":[]}");
    resource = (LwM2mResource) decoder
        .decode(b.toString().getBytes(), ContentFormat.JSON, new LwM2mPath(3, 0, 6),
            model);
    assertNotNull(resource);
    assertTrue(resource instanceof LwM2mMultipleResource);
    assertEquals(6, resource.getId());
