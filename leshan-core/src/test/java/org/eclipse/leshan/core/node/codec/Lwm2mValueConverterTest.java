...
public class Lwm2mValueConverterTest {
  ...
  public void testConvertValueParsesHexString() {
    ...
    Object opaqueValue = new DefaultLwM2mValueConverter()
        .convertValue(hexString, Type.STRING, Type.OPAQUE, null);
  ...
  public void testConvertPositiveFloatToInteger() {
    ...
    Object convertValue = new DefaultLwM2mValueConverter()
        .convertValue(floatValue, Type.FLOAT, Type.INTEGER, null);
  ...
  public void testConvertPositiveIntegerToFloat() {
    long longValue = 999l;
    Object convertValue = new DefaultLwM2mValueConverter()
        .convertValue(longValue, Type.INTEGER, Type.FLOAT, null);
