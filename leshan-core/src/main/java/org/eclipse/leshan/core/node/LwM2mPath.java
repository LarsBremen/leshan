...
public class LwM2mPath {
   ...
   *
   * @return the resource ID. Can be <code>null</code> when this is a root/object/object instance
   * path.
   */
   ...
   *
   * @return the resource instance ID. Can be <code>null</code> when this is a root/object/object
  ...
  public boolean isRoot() {
    return objectId == null && objectInstanceId == null && resourceId == null
  ...
  /**
   * The string representation of the path: /{Object ID}/{ObjectInstance ID}/{Resource
