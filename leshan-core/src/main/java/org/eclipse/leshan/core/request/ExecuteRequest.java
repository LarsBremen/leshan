...
/**
 * A Lightweight M2M request for initiate some action, it can only be performed on individual
 * Resources.
 */
public class ExecuteRequest extends AbstractDownlinkRequest<ExecuteResponse> {
  ...
  /**
   * Creates a new <em>execute</em> request for a resource accepting parameters encoded as plain
   * text.
   *
   * @param path the path of the resource to execute
