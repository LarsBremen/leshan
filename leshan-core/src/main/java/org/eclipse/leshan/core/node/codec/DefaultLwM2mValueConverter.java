...
public class DefaultLwM2mValueConverter implements LwM2mValueConverter {
  ...
  @Override
  public Object convertValue(Object value, Type currentType, Type expectedType,
        ...
        if (currentType == Type.STRING) {
          ...
          try {
            ...
            throw new CodecException(
                "Unable to convert hexastring [%s] to byte array for resource %s", value,
                resourcePath);
          }
        }
        break;
    ...
    throw new CodecException("Invalid value type for resource %s, expected %s, got %s",
        resourcePath, expectedType,
        currentType);
  }
}
