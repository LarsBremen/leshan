...
/**
 * A Lightweight M2M request for observing changes of a specific Resource, Resources within an
 * Object Instance or for all the Object Instances of an Object within the LWM2M Client.
 */
public class ObserveRequest extends AbstractDownlinkRequest<ObserveResponse> {
  ...
  /**
   * Creates a request for observing future changes of all instances of a particular object of a
   * client.
   *
  ...
  /**
   * Creates a request for observing future changes of a particular LWM2M node (object, object
  ...
  /**
   * @return an unmodifiable map containing the additional information relative to this observe
   * request.
   */
