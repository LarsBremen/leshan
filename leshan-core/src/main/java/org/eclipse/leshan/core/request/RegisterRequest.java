...
/**
 * A Lightweight M2M request for sending the LWM2M Client properties required by the LWM2M Server to
 * contact the LWM2M Client.
 */
public class RegisterRequest implements UplinkRequest<RegisterResponse> {
   ...
   * @param smsNumber is the MSISDN where the LWM2M Client can be reached for use with the SMS
   * binding.
   * @param objectLinks is the list of Objects supported and Object Instances available on the LWM2M
   * Client.
   * @param additionalAttributes are any attributes/parameters which is out of the LWM2M
   * specification.
   * @throws InvalidRequestException if endpoint name or objectlinks is empty.
   */
  public RegisterRequest(String endpointName, Long lifetime, String lwVersion,
