...
public class ObjectModelSerDes extends JsonSerDes<ObjectModel> {
  ...
  public ObjectModel deserialize(JsonObject o) {
    ...
    List<ResourceModel> resourceSpecs = resourceModelSerDes
        .deserialize(o.get("resourcedefs").asArray());

    return new ObjectModel(id, name, description, version, "multiple".equals(instancetype),
        mandatory,
        resourceSpecs);
  }
}
