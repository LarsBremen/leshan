...
/**
 * A Lightweight M2M request for discovering LWM2M Attributes attached to an Object, Object
 * Instances, and Resources.
 */
public class DiscoverRequest extends AbstractDownlinkRequest<DiscoverResponse> {

  /**
   * Creates a request for discovering the resources implemented by a client for a particular object
   * type.
   *
  ...
  /**
   * Creates a request for discovering the attributes of a particular resource implemented by a
   * client.
   *
   * @param objectId the object type
   * @param objectInstanceId the object instance
  ...
  /**
   * Create a request for discovering the attributes of a particular object/instance/resource
   * targeted by a specific path.
   *
