...
public class ObjectModel {
  ...
  public ObjectModel(int id, String name, String description, String version, boolean multiple,
    ...
    for (ResourceModel resource : resources) {
      ...
      if (old != null) {
        LOG.debug("Model already exists for resource {} of object {}. Overriding it.", resource.id,
            id);
      }
  ...
  public String toString() {
    ...
    builder.append("ObjectModel [id=").append(id).append(", name=").append(name)
        .append(", description=")
        .append(description).append(", version=").append(version).append(", multiple=")
        .append(multiple)
        .append(", mandatory=").append(mandatory).append(", resources=").append(resources)
        .append("]");
