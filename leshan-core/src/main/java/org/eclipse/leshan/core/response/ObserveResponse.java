...
public class ObserveResponse extends ReadResponse {
  ...
  public ObserveResponse(ResponseCode code, LwM2mNode content,
    ...
    super(code, timestampedValues != null && !timestampedValues.isEmpty() ? timestampedValues.get(0)
        .getNode()
  ...
  public String toString() {
    if (errorMessage != null) {
      ...
      return String.format(
          "ObserveResponse [code=%s, content=%s, observation=%s, timestampedValues= %d nodes]",
          code, content, observation, timestampedValues.size());
    } else {
      return String.format("ObserveResponse [code=%s, content=%s, observation=%s]", code, content,
          observation);
    }
  }
