...
public interface LwM2mResource extends LwM2mNode {
   ...
   *
   * If {@link #getType()} returns {@link Type#BOOLEAN}, the value is a {@link Boolean}.<br> If
   * {@link #getType()} returns {@link Type#STRING}, the value is a {@link String}.<br> If {@link
   * #getType()} returns {@link Type#OPAQUE}, the value is a byte array.<br> If {@link #getType()}
   * returns {@link Type#TIME}, the value is a {@link Date}.<br> If {@link #getType()} returns
   * {@link Type#INTEGER}, the value is a {@link Long}.<br> If {@link #getType()} returns {@link
   * Type#FLOAT}, the value is a {@link Double}.<br>
   *
