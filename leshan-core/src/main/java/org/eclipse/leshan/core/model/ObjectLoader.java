...
public class ObjectLoader {
  ...
  private static final String[] ddfpaths = new String[]{"LWM2M_Security-v1_0.xml",
  ...
  /**
   * Load object definition from DDF resources following rules of {@link
  ...
  public static List<ObjectModel> loadDdfResources(String path, String[] filenames) {
    ...
    for (String filename : filenames) {
      String fullpath =
          StringUtils.removeEnd(path, "/") + "/" + StringUtils.removeStart(filename, "/");
