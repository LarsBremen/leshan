...
/**
 * The request to change the value of a Resource, an array of Resources Instances or multiple
...
public class WriteRequest extends AbstractDownlinkRequest<WriteResponse> {
  ...
  public enum Mode {
    /**
     * Replaces the Object Instance or the Resource(s) with the new value provided in the “Write”
     * operation. (see section 5.3.3 of the LW M2M spec).
     */
    REPLACE,
    /**
     * Adds or updates Resources provided in the new value and leaves other existing Resources
     * unchanged. (see section 5.3.3 of the LW M2M spec).
     */
    UPDATE
  }
   ...
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
   ...
   * @param resources the list of resources to write.
   */
  public WriteRequest(Mode mode, int objectId, int objectInstanceId,
  ...
  /**
   * Request to write a <b>String Single-Instance Resource</b> using the given content format (TEXT,
   * TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  ...
  /**
   * Request to write a <b>Boolean Single-Instance Resource</b> using the given content format
   * (TEXT, TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  public WriteRequest(ContentFormat contentFormat, int objectId, int objectInstanceId,
      int resourceId, boolean value)
      throws InvalidRequestException {
    this(Mode.REPLACE, contentFormat, new LwM2mPath(objectId, objectInstanceId, resourceId),
  ...
  /**
   * Request to write a <b>Integer Single-Instance Resource</b> using the given content format
   * (TEXT, TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  public WriteRequest(ContentFormat contentFormat, int objectId, int objectInstanceId,
      int resourceId, long value)
      throws InvalidRequestException {
    this(Mode.REPLACE, contentFormat, new LwM2mPath(objectId, objectInstanceId, resourceId),
  ...
  /**
   * Request to write a <b> Float Single-Instance Resource</b> using the given content format (TEXT,
   * TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  public WriteRequest(ContentFormat contentFormat, int objectId, int objectInstanceId,
      int resourceId, double value)
      throws InvalidRequestException {
    this(Mode.REPLACE, contentFormat, new LwM2mPath(objectId, objectInstanceId, resourceId),
  ...
  /**
   * Request to write a <b> Date Single-Instance Resource</b> using the given content format (TEXT,
   * TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  public WriteRequest(ContentFormat contentFormat, int objectId, int objectInstanceId,
      int resourceId, Date value)
      throws InvalidRequestException {
    this(Mode.REPLACE, contentFormat, new LwM2mPath(objectId, objectInstanceId, resourceId),
  ...
  /**
   * Request to write a <b> Binary Single-Instance Resource</b> using the given content format
   * (OPAQUE, TLV, JSON).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
  public WriteRequest(ContentFormat contentFormat, int objectId, int objectInstanceId,
      int resourceId, byte[] value)
      throws InvalidRequestException {
    this(Mode.REPLACE, contentFormat, new LwM2mPath(objectId, objectInstanceId, resourceId),
  ...
  /**
   * Request to write a <b> Objlnk Single-Instance Resource</b> using the given content format (TLV,
   * JSON, TEXT).
   *
   * @throws InvalidRequestException if bad @{link ContentFormat} format was used.
   */
   ...
   */
  public WriteRequest(int objectId, int objectInstanceId, int resourceId, Map<Integer, ?> values,
      Type type)
      throws InvalidRequestException {
  ...
  private WriteRequest(Mode mode, ContentFormat format, LwM2mPath target, LwM2mNode node) {
    ...
    if (getPath().isResource() && mode == Mode.UPDATE) {
      throw new InvalidRequestException("Invalid mode for '%s': update is not allowed on resource",
          target);
    }
    ...
    if (ContentFormat.TEXT == format || ContentFormat.OPAQUE == format) {
      if (!getPath().isResource()) {
        throw new InvalidRequestException(
            "Invalid format for %s: %s format must be used only for single resources", target,
            format);
      } else {
  ...
  /**
   * @return <code>true</code> if all resources are to be replaced (see section 5.3.3 of the LW M2M
   * spec).
   */
  ...
  /**
   * @return <code>true</code> if this is a partial update request (see section 5.3.3 of the LW M2M
   * spec).
   */
  ...
  public String toString() {
    return String.format("WriteRequest [mode=%s, path=%s, format=%s, node=%s]", mode, getPath(),
        contentFormat,
        node);
  }
