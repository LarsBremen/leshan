...
public class Tlv {
   ...
   * @param children the list of children TLV (must be <code>null</code> for type {@link
   * TlvType#RESOURCE_VALUE}
   * @param value the raw contained value, only for type {@link TlvType#RESOURCE_VALUE}
   * <code>null</code> for the other types
