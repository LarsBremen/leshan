 ...
 * <li><b>IsAlpha/IsNumeric/IsWhitespace/IsAsciiPrintable</b> - checks the characters in a
 * String</li>
 ...
 * <li><b>LevensteinDistance</b> - the number of changes needed to change one String into
 * another</li>
 * </ul>
 *
 * <p>
 ...
 *
 * <p>
 * <code>StringUtils</code> handles <code>null</code> input Strings quietly. That is to say that a
 * <code>null</code>
 * input will return <code>null</code>. Where a <code>boolean</code> or <code>int</code> is being
 * returned details vary by method.
 * </p>
 *
 * <p>
 * A side effect of the <code>null</code> handling is that a <code>NullPointerException</code>
 * should be considered a bug in <code>StringUtils</code> (except for deprecated methods).
 * </p>
 *
 * <p>
 * Methods in this class give sample code to explain their operation. The symbol <code>*</code> is
 * used to indicate any input including <code>null</code>.
 * </p>
 *
 * <p>
 * #ThreadSafe#
...
public class StringUtils {
   ...
   *
   * <p>
   * <code>null</code>s are handled without exceptions. Two <code>null</code> references are
   ...
   *
   * <p>
   * A <code>null</code> source string will return <code>null</code>. An empty ("") source string
   * will return the empty string. A <code>null</code> search string will return the source string.
   * </p>
   *
   * <pre>
