...
public class Hex {
  ...
  public Object decode(final Object object) throws IllegalArgumentException {
    try {
      final char[] charArray =
          object instanceof String ? ((String) object).toCharArray() : (char[]) object;
   ...
   * <p>
   * The conversion from hexadecimal characters to the returned bytes is performed with the charset
   * named by {@link #getCharset()}.
   * </p>
   *
   ...
   * <p>
   * The conversion from hexadecimal characters to bytes to be encoded to performed with the charset
   * named by {@link #getCharset()}.
   * </p>
   *
  ...
  public Object encode(final Object object) throws IllegalArgumentException {
    try {
      final byte[] byteArray =
          object instanceof String ? ((String) object).getBytes(this.getCharset())
              : (byte[]) object;
