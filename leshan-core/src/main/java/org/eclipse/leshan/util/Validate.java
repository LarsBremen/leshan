...
public class Validate {
   ...
   * expression, such as validating an object or using your own custom validation expression.
   * </p>
   *
   * <pre>
   ...
   *
   * <p>
   * For performance reasons, the object value is passed as a separate parameter and appended to the
   ...
   *
   * <p>
   * For performance reasons, the double value is passed as a separate parameter and appended to the
   * exception message only in the case of an error.
   * </p>
   *
   * @param expression the boolean expression to check
   ...
   * This method is useful when validating according to an arbitrary boolean expression, such as
  ...
  /**
   * <p>
   * Validate that the specified argument is not <code>null</code>; otherwise throwing an
   * exception.
   *
   * <pre>
  ...
  /**
   * <p>
   * Validate that the specified argument map is neither <code>null</code> nor a size of zero (no
  ...
  /**
   * <p>
   * Validate that the specified argument array is neither <code>null</code> nor contains any
   * elements that are
   * <code>null</code>; otherwise throwing an exception with the specified message.
   *
   * <pre>
   ...
   *
   * <p>
   * If the array is <code>null</code>, then the message in the exception is &quot;The validated
   * object is null&quot;.
   * </p>
   *
   * @param array the array to check
   * @param message the exception message if the collection has <code>null</code> elements
   * @throws IllegalArgumentException if the array is <code>null</code> or an element in the array
   * is
   * <code>null</code>
   */
   ...
   * Validate that the specified argument array is neither <code>null</code> nor contains any
   * elements that are
   * <code>null</code>; otherwise throwing an exception.
   *
   * <pre>
   ...
   *
   * <p>
   * If the array has a <code>null</code> element, then the message in the exception is &quot;The
  ...
  /**
   * <p>
   * Validate that the specified argument collection is neither <code>null</code> nor contains any
   * elements that are
   * <code>null</code>; otherwise throwing an exception with the specified message.
   *
   * <pre>
   ...
   *
   * <p>
   * If the collection is <code>null</code>, then the message in the exception is &quot;The
   * validated object is null&quot;.
   * </p>
   *
   * @param collection the collection to check
   * @param message the exception message if the collection has
   * @throws IllegalArgumentException if the collection is <code>null</code> or an element in the
   * collection is
   * <code>null</code>
   */
   ...
   *
   * <p>
   * If the collection has a <code>null</code> element, then the message in the exception is
   * &quot;The validated collection contains null element at index: &quot followed by the index.
   * </p>
   *
   * @param collection the collection to check
   * @throws IllegalArgumentException if the collection is <code>null</code> or an element in the
  ...
  /**
   * <p>
   * Validate an argument, throwing <code>IllegalArgumentException</code> if the argument collection
   * is
   ...
   *
   * <p>
   * The message in the exception is 'The validated collection contains an element not of type clazz
   * at index: '.
   * </p>
   *
   * @param collection the collection to check, not null
