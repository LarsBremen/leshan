<rpk-input>
    ...
    <div class={ form-group:true, has-error: pubkey.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="pubkey" ref="pubkey"
                      oninput={validate_pubkey} onblur={validate_pubkey}></textarea>
            <p class="text-right text-muted small" style="margin:0">SubjectPublicKeyInfo der encoded
                in Hexadecimal</p>
    ...
    <div class={ form-group:true, has-error: privkey.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="privkey" ref="privkey"
                      oninput={validate_privkey} onblur={validate_privkey}></textarea>
            <p class="text-right text-muted small" style="margin:0">PKCS8 format der encoded in
                Hexadecimal</p>
    ...
    <div class={ form-group:true, has-error: servpubkey.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="servpubkey"
                      ref="servpubkey" oninput={validate_servpubkey} onblur={validate_servpubkey}
                      disabled={disable.serverpubkey} placeholder={serverpubkey}></textarea>
            <p class="text-right text-muted small" style="margin:0">SubjectPublicKeyInfo der encoded
                in Hexadecimal</p>
    ...
    <script>
      ...
      function has_error() {
        ...
        return typeof tag.pubkey.error === "undefined" || tag.pubkey.error ||
            ...
            (tag.serverpubkey === "" && (typeof tag.servpubkey.error === "undefined"
                || tag.servpubkey.error));
      }

      function get_value() {
        return {
          pubkey: tag.refs.pubkey.value,
          privkey: tag.refs.privkey.value,
          servpubkey: tag.refs.servpubkey.value || tag.serverpubkey
        };
      }
    </script>
</rpk-input>