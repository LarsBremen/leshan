<securityconfig-input>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <input class="form-control" id="uri" ref="uri" placeholder={default_uri()}
                   disabled={disable.uri}>
        </div>
    </div>
    ...
    <div if={ refs.secMode.value==
    "rpk" } >
    <rpk-input ref="rpk" onchange={onchange} disable={disable}
               serverpubkey={serverpubkey}></rpk-input>
    </div>
