<psk-input>
    ...
    <div class={ form-group:true, has-error: pskId.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="pskId" ref="pskId"
                      oninput={validate_pskId} onblur={validate_pskId}></textarea>
    ...
    <div class={ form-group:true, has-error: pskVal.error }>
        ...
        <div class="col-sm-8">
            <textarea class="form-control" style="resize:none" rows="3" id="pskVal" ref="pskVal"
                      oninput={validate_pskVal} onblur={validate_pskVal}></textarea>
    ...
    <script>
      ...
      function has_error() {
        return typeof tag.pskId.error === "undefined" || tag.pskId.error || typeof tag.pskVal.error
            === "undefined" || tag.pskVal.error;
      }
