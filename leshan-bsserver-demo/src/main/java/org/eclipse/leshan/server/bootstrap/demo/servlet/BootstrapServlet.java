...
public class BootstrapServlet extends HttpServlet {
  ...
  private static class SignedByteUnsignedByteAdapter implements JsonSerializer<Byte>,
  ...
  public BootstrapServlet(BootstrapStoreImpl bsStore) {
    ...
    this.gson = new GsonBuilder()
        .registerTypeHierarchyAdapter(Byte.class, new SignedByteUnsignedByteAdapter())
        .create();
  }
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    resp.getOutputStream()
        .write(gson.toJson(bsStore.getBootstrapConfigs()).getBytes(StandardCharsets.UTF_8));
  }
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      BootstrapConfig cfg = gson
          .fromJson(new InputStreamReader(req.getInputStream()), BootstrapConfig.class);
