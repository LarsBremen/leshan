...
/**
 * A DTLS security store using the provisioned bootstrap information for finding the DTLS/PSK
 * credentials.
 */
public class BootstrapSecurityStoreImpl implements BootstrapSecurityStore {
  ...
  public List<SecurityInfo> getAllByEndpoint(String endpoint) {
    ...
    for (Map.Entry<Integer, BootstrapConfig.ServerSecurity> bsEntry : bsConfig.security
        .entrySet()) {
