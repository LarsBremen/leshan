...
public class SecureIntegrationTestHelper extends IntegrationTestHelper {
  ...
  public SecureIntegrationTestHelper() {
    ...
    try {
      ...
      byte[] publicX = Hex
          .decodeHex(
              "89c048261979208666f2bfb188be1968fc9021c416ce12828c06f4e314c167b5".toCharArray());
      byte[] publicY = Hex
          .decodeHex(
              "cbf1eb7587f08e01688d9ada4be859137ca49f79394bad9179326b3090967b68".toCharArray());
      byte[] privateS = Hex
          .decodeHex(
              "e67b68d2aaeb6550f19d98cade3ad62b39532e02e6b422e1f7ea189dabaea5d2".toCharArray());
      ...
      KeySpec publicKeySpec = new ECPublicKeySpec(
          new ECPoint(new BigInteger(publicX), new BigInteger(publicY)),
          parameterSpec);
      ...
      try (FileInputStream clientKeyStoreFile = new FileInputStream(
          "./credentials/clientKeyStore.jks")) {
    ...
    try {
      ...
      byte[] publicX = Hex
          .decodeHex(
              "fcc28728c123b155be410fc1c0651da374fc6ebe7f96606e90d927d188894a73".toCharArray());
      byte[] publicY = Hex
          .decodeHex(
              "d2ffaa73957d76984633fc1cc54d0b763ca0559a9dff9706e9f4557dacc3f52a".toCharArray());
      byte[] privateS = Hex
          .decodeHex(
              "1dae121ba406802ef07c193c1ee4df91115aabd79c1ed7f4c0ef7ef6a5449400".toCharArray());
      ...
      try (FileInputStream serverKeyStoreFile = new FileInputStream(
          "./credentials/serverKeyStore.jks")) {
  ...
  public void createPSKClient() {
    ...
    builder.setEndpointFactory(new EndpointFactory() {
      ...
      @Override
      public CoapEndpoint createUnsecuredEndpoint(InetSocketAddress address,
      ...
      @Override
      public CoapEndpoint createSecuredEndpoint(DtlsConnectorConfig dtlsConfig,
          NetworkConfig coapConfig,
          ObservationStore store) {
        CoapEndpoint.CoapEndpointBuilder builder = new CoapEndpoint.CoapEndpointBuilder();
  ...
  public void createX509CertClient(PrivateKey privatekey, Certificate[] trustedCertificates) {
    ...
    initializer.setInstancesForObject(LwM2mId.SECURITY, Security.noSec(
        "coaps://" + server.getSecuredAddress().getHostString() + ":" + server.getSecuredAddress()
            .getPort(),
        12345));
    initializer
        .setInstancesForObject(LwM2mId.SERVER, new Server(12345, LIFETIME, BindingMode.U, false));
