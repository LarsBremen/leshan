...
public class SynchronousRegistrationListener implements RegistrationListener {
   ...
   */
  public void waitForRegister(long timeout, TimeUnit timeUnit)
   ...
   * @throws TimeoutException if wait timeouts
   */
  public void waitForUpdate(long timeout, TimeUnit timeUnit)
      throws InterruptedException, TimeoutException {
    try {
   ...
   * @throws TimeoutException if wait timeouts
   */
  public void waitForDeregister(long timeout, TimeUnit timeUnit)
      throws InterruptedException, TimeoutException {
    try {
