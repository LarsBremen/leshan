...
public class DiscoverTest {
  ...
  public void can_discover_object() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3));
    ...
    assertEquals(
        "</3>, </3/0>, </3/0/0>, </3/0/1>, </3/0/2>, </3/0/11>, </3/0/14>, </3/0/15>, </3/0/16>",
  ...
  public void cant_discover_non_existent_object() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(4));
  ...
  public void can_discover_object_instance() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 0));
  ...
  public void cant_discover_non_existent_instance() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 1));
  ...
  public void can_discover_resource() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 0, 0));
  ...
  public void cant_discover_resource_of_non_existent_object() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(4, 0, 0));
  ...
  public void cant_discover_resource_of_non_existent_instance() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 1, 0));
  ...
  public void cant_discover_resource_of_non_existent_instance_and_resource()
    ...
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 1, 20));
  ...
  public void cant_discover_resource_of_non_existent_resource() throws InterruptedException {
    // read ACL object
    DiscoverResponse response = helper.server
        .send(helper.getCurrentRegistration(), new DiscoverRequest(3, 0, 42));
