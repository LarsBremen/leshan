...
public class SynchronousClientObserver implements LwM2mClientObserver {
  ...
  @Override
  public void onBootstrapFailure(Identity bsserver, ResponseCode responseCode,
      String errorMessage) {
  ...
  @Override
  public void onDeregistrationFailure(Server server, ResponseCode responseCode,
      String errorMessage) {
   ...
   */
  public boolean waitForRegistration(long timeout, TimeUnit timeUnit)
   ...
   */
  public boolean waitForUpdate(long timeout, TimeUnit timeUnit)
      throws InterruptedException, TimeoutException {
    try {
   ...
   */
  public boolean waitForBootstrap(long timeout, TimeUnit timeUnit)
      throws InterruptedException, TimeoutException {
    try {
