 ...
 *
 * Will start a LWM2M server which would be part of a large cluster group. This group of cluster
 * node will share state and communicate using Redis. So they all need too be connected to the same
 * redis server.
 */
public class LeshanClusterServer {
  ...
  public static void main(String[] args) {
    ...
    options.addOption("n", "instanceID", true,
        "Sets the unique identifier of this instance in the cluster.");
    options.addOption("lh", "coaphost", true,
        "Sets the local CoAP address.\n  Default: any local address.");
  ...
  public static void createAndStartServer(String clusterInstanceId, String localAddress,
      int localPort,
    ...
    new RedisRequestResponseHandler(jedis, lwServer, lwServer.getRegistrationService(),
        tokenHandler,
