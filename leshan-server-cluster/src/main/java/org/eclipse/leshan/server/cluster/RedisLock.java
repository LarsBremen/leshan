 ...
 * http://redis.io/topics/distlock#correct-implementation-with-a-single-instance for more
 * information).
 */
public class RedisLock {

  private static final byte[] NX_OPTION = "NX"
      .getBytes(UTF_8); // set the key if it does not already exist
