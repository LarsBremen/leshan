...
public class CoapRequestBuilder implements DownlinkRequestVisitor {
  ...
  public CoapRequestBuilder(Identity destination, String rootPath, String registrationId,
      String endpoint,
  ...
  public void visit(CreateRequest request) {
    ...
    int instanceId =
        request.getInstanceId() != null ? request.getInstanceId() : LwM2mObjectInstance.UNDEFINED;
    coapRequest
        .setPayload(encoder.encode(new LwM2mObjectInstance(instanceId, request.getResources()),
  ...
  public void visit(ObserveRequest request) {
    ...
    coapRequest.setUserContext(
        ObserveUtil.createCoapObserveRequestContext(endpoint, registrationId, request));
  }
