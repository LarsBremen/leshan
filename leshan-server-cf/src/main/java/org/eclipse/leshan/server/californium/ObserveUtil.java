...
/**
 * Utility functions to help to handle observation in Leshan. Those helper functions are only needed
 * if you're implementing your own {@link CaliforniumRegistrationStore}.
 */
public class ObserveUtil {
   ...
   */
  public static Map<String, String> createCoapObserveRequestContext(String endpoint,
