...
public class LwM2mResponseBuilder<T extends LwM2mResponse> implements DownlinkRequestVisitor {
  ...
  public LwM2mResponseBuilder(Request coapRequest, Response coapResponse, Registration registration,
      LwM2mModel model,
  ...
  public void visit(ReadRequest request) {
    ...
    } else if (coapResponse.getCode()
        == org.eclipse.californium.core.coap.CoAP.ResponseCode.CONTENT) {
  ...
  public void visit(DiscoverRequest request) {
    if (coapResponse.isError()) {
      ...
      // handle success response:
      Link[] links;
      if (MediaTypeRegistry.APPLICATION_LINK_FORMAT != coapResponse.getOptions()
          .getContentFormat()) {
        LOG.debug(
            "Expected LWM2M Client [{}] to return application/link-format [{}] content but got [{}]",
  ...
  public void visit(WriteRequest request) {
    if (coapResponse.isError()) {
      ...
      lwM2mresponse = new WriteResponse(toLwM2mResponseCode(coapResponse.getCode()),
        ...
        == org.eclipse.californium.core.coap.CoAP.ResponseCode.CHANGED) {
      // handle success response:
  ...
  public void visit(CreateRequest request) {
    if (coapResponse.isError()) {
      ...
      lwM2mresponse = new CreateResponse(toLwM2mResponseCode(coapResponse.getCode()), null,
        ...
        == org.eclipse.californium.core.coap.CoAP.ResponseCode.CREATED) {
      // handle success response:
  ...
  public void visit(DeleteRequest request) {
    if (coapResponse.isError()) {
      ...
      lwM2mresponse = new DeleteResponse(toLwM2mResponseCode(coapResponse.getCode()),
        ...
        == org.eclipse.californium.core.coap.CoAP.ResponseCode.DELETED) {
      // handle success response:
  ...
  public void visit(ObserveRequest request) {
    if (coapResponse.isError()) {
      ...
      if (coapResponse.getOptions().hasObserve()) {
        ...
        lwM2mresponse = new ObserveResponse(toLwM2mResponseCode(coapResponse.getCode()), content,
            null,
  ...
  private LwM2mNode decodeCoapResponse(LwM2mPath path, Response coapResponse,
    ...
    try {
      ...
      if (LOG.isDebugEnabled()) {
        ...
        LOG.debug(
            String.format(
                "Unable to decode response payload of request [%s] from client [%s] [payload:%s]",
                request, endpoint, Hex.encodeHexString(payload)));
      }
      throw new InvalidResponseException(e,
          "Unable to decode response payload of request [%s] from client [%s]",
          request, endpoint);
    }
  }
  ...
  private void handleUnexpectedResponseCode(String clientEndpoint, LwM2mRequest<?> request,
    ...
    throw new InvalidResponseException(
        "Client [%s] returned unexpected response code [%s] for [%s]",
