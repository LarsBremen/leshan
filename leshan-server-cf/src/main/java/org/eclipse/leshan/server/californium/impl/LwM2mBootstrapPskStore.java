 ...
 *
 * Only supports getting the PSK key for a given identity. (Getting identity from IP only makes
...
public class LwM2mBootstrapPskStore implements PskStore {
  ...
  public String getIdentity(InetSocketAddress inetAddress) {
    throw new UnsupportedOperationException(
        "Getting PSK Id by IP addresss dos not make sense on BS server side.");
  }
