...
public class ObservationServiceTest {
  ...
  private Observation givenAnObservation(String registrationId, LwM2mPath target) {
    ...
    coapRequest.setDestinationContext(
        EndpointContextUtil.extractContext(support.registration.getIdentity()));
    Map<String, String> context = ObserveUtil
        .createCoapObserveRequestContext(registration.getEndpoint(),
    ...
    Observation observation = new Observation(coapRequest.getToken().getBytes(), registrationId,
        target, null);
