...
public interface EditableSecurityStore extends SecurityStore {
   ...
   * @return the {@link SecurityInfo} previously stored for the end-point or <code>null</code> if
   * there was no security information for the end-point.
   * @throws NonUniqueSecurityInfoException if some identifiers (PSK identity, RPK public key...)
   * are not unique among all end-points.
   */
