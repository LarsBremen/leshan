...
/**
 * Listener that controls the state of the client (awake/sleeping) It is in charge of sending all
 * the queued messages when the client is awake (has sent an update message), and controlling the
 * time the client is awake before going to sleep.
 */
