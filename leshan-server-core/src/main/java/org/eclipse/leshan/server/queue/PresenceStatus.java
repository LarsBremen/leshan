...
/**
 * Class that contains all the necessary elements to handle the queue mode. Every registration
 * object that uses Queue Mode has a PresenceStatus object linked to it for handling this mode.
 */
...
public class PresenceStatus {
  ...
  /**
   * Set the client state to awake. This should be called when an update message is received from
   * the server. It starts the client awake timer.
   *
  ...
  /**
   * Set the client state to sleeping. This should be called when the the time the client waits
   * before going to sleep expires, or when the client is not responding. It also notifies the
   * listeners inside the {@link PresenceService}. It stops the client awake timer.
   *
