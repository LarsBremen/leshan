...
public class Registration implements Serializable {
  ...
  protected Registration(String id, String endpoint, Identity identity, String lwM2mVersion,
      ...
      Date registrationDate, Date lastUpdate,
      Map<String, String> additionalRegistrationAttributes) {
  ...
  /**
   * Gets the network address and port number of LWM2M Server's CoAP endpoint the client originally
   * registered at.
   *
   * A LWM2M Server may listen on multiple CoAP end points, e.g. a non-secure and a secure one.
   * Clients are often behind a firewall which will only let incoming UDP packets pass if they
   * originate from the same address:port that the client has initiated communication with, e.g. by
   * means of registering with the LWM2M Server. It is therefore important to know, which of the
   * server's CoAP end points the client contacted for registration.
   *
   * This information can be used to uniquely identify the CoAP endpoint that should be used to
   * access resources on the client.
   *
   ...
   *
   * @return true if the last registration update was done less than lifetime+gracePeriod seconds
   * ago.
   */
  ...
  public String toString() {
    return String.format(
        ...
        registrationDate, identity, registrationEndpointAddress, lifeTimeInSec, smsNumber,
        lwM2mVersion,
   ...
   *
   * @return <code>true</code> if the other object is a Client instance and its <em>endpoint</em>
   * property has the same value as this Client
   */
  @Override
  ...
  public static class Builder {
    ...
    public Builder additionalRegistrationAttributes(
        Map<String, String> additionalRegistrationAttributes) {
    ...
    public Registration build() {
      return new Registration(Builder.this.registrationId, Builder.this.endpoint,
          Builder.this.identity,
          Builder.this.lwM2mVersion, Builder.this.lifeTimeInSec, Builder.this.smsNumber,
          this.bindingMode,
          this.objectLinks, this.registrationEndpointAddress, this.registrationDate,
          this.lastUpdate,
