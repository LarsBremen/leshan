...
public class BootstrapHandlerTest {
  ...
  public void error_if_not_authorized() {
    ...
    BootstrapResponse bootstrapResponse = bsHandler
        .bootstrap(Identity.psk(new InetSocketAddress(4242), "pskdentity"),
            new BootstrapRequest("enpoint"));
  ...
  public void notifies_at_end_of_successful_bootstrap() {
    ...
    BootstrapHandler bsHandler = new BootstrapHandler(bsStore, requestSender, bsSessionManager,
        new Executor() {
    ...
    bsHandler.bootstrap(Identity.psk(new InetSocketAddress(4242), "pskdentity"),
        new BootstrapRequest("enpoint"));
  ...
  private class MockRequestSender implements LwM2mBootstrapRequestSender {
    ...
    @Override
    public <T extends LwM2mResponse> T send(String clientEndpoint, Identity destination,
