...
/**
 * A CoAP {@link Resource} in charge of handling the Bootstrap Finish indication from the bootstrap
 * server.
 */
public class BootstrapResource extends CoapResource {
  ...
  public void handlePOST(CoapExchange exchange) {
    ...
    BootstrapFinishResponse response = bootstrapHandler
        .finished(identity, new BootstrapFinishRequest());
