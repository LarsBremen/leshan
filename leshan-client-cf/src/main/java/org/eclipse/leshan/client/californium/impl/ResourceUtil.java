...
public class ResourceUtil {
  ...
  public static ServerIdentity extractServerIdentity(CoapExchange exchange,
      BootstrapHandler bootstrapHandler) {
    Identity identity = EndpointContextUtil
        .extractIdentity(exchange.advanced().getRequest().getSourceContext());
