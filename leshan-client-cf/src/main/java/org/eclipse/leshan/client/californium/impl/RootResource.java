...
/**
 * A {@link CoapResource} resource in charge of handling Bootstrap Delete requests targeting the "/"
 * URI.
 */
public class RootResource extends CoapResource {
  ...
  public void handleDELETE(CoapExchange exchange) {
    ...
    BootstrapDeleteResponse response = bootstrapHandler
        .delete(identity, new BootstrapDeleteRequest());
